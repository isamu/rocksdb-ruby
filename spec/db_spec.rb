...
describe RocksDB do
  ...
  context "enumerable" do
    ...
    it 'iterates with each_range' do
    ...
    it 'should read prefix data' do
      @rocksdb.put("test0:multi0", "a")
      result = {}
    ...
    it 'iterates over values with each' do
      values = []
    ...
    it 'iterates over values with reverse_each' do
      values = []
      ...
      expect(values).to eq ["c", "b", "a"]
    end

    it 'iterates over keys with each_key' do
      keys = []
      ...
      expect(keys).to eq ["test1:0001", "test1:0002", "test1:0003"]
    end

    it 'iterates over values keys with each_pair' do
      pairs = {}
